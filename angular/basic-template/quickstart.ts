...
class JokeComponent {
  ...
  @Output('joke') dataDelete = new EventEmitter<Joke>();

  deleteJoke() {
    this.dataDelete.emit(this.data);
  }
}
...
<joke *ngFor="let j of jokes" [joke]="j" (joke)="deleteJoke($event)"></joke>
  `
})
